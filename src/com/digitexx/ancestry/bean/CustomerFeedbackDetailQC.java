 ...
 * 
 */
public class CustomerFeedbackDetailQC
{
	private long id;
	...
	/**
	 * @param qc_status the qc_status to set
	 */
	 ...
	 * @return the value_qc
	 */
	public String getValue_qc() {
		return value_qc;
	}
	/**
	 * @param value_qc the value_qc to set
	 */
	public void setValue_qc(String value_qc) {
		this.value_qc = value_qc;
	}
	/**
	 * @return the mistake
	 */
